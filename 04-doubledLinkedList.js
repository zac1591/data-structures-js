...
const doubleLinkedList = new DoubledLinkedList();
...
console.log(`Tamaño de lista ${doubleLinkedList.getSize()}`);
console.log(`Esta vacía? ${doubleLinkedList.isEmpty()}`);
